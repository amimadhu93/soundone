...
const soundList = {
  one: require("./assets/arti.mp3"),
  two: require("./assets/ar.mp3"),
  three: require("./assets/arti.mp3"),
  four: require("./assets/ar.mp3"),
  five: require("./assets/arti.mp3"),
  six: require("./assets/arti.mp3"),
  seven: require("./assets/arti.mp3"),
  eight: require("./assets/arti.mp3"),
  nine: require("./assets/arti.mp3"),
  ten: require("./assets/arti.mp3")
};
...
constructor(props)
    ...
    playSound = async () => {
        try {
          ...
          await this.audioPlayer.loadAsync(require("./assets/arti.mp3"));
      ...
      <ScrollView style={styles.container}>
        <View style={styles.gridContainer}>
          ...
          <View style={styles.rowContainer}>
            ...
            >
              <Text style={styles.itemText}>Onew</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[
