...
const ICON_PLAY_BUTTON = new Icon(
  require("./assets/images/anuppause_1.png"),
  34,
  51
);
const ICON_PAUSE_BUTTON = new Icon(
  require("./assets/images/anupplay_1.png"),
  34,
  51
);
const ICON_STOP_BUTTON = new Icon(
  require("./assets/images/anupimg/stop.png"),
  22,
  22
);
const ICON_FORWARD_BUTTON = new Icon(
  require("./assets/images/anupimg/nextone.png"),
  33,
  25
);
const ICON_BACK_BUTTON = new Icon(
  require("./assets/images/anupimg/previous.png"),
  33,
  25
);

const ICON_LOOP_ALL_BUTTON = new Icon(
  require("./assets/images/anupimg/repeat_all.png"),
  77,
  35
);
const ICON_LOOP_ONE_BUTTON = new Icon(
  require("./assets/images/anupimg/repeat_one.png"),
  77,
  35
);

const ICON_MUTED_BUTTON = new Icon(
  require("./assets/images/anupimg/volumef.png"),
  67,
  58
);
const ICON_UNMUTED_BUTTON = new Icon(
  require("./assets/images/anupimg/volume.png"),
  67,
  58
);

const ICON_TRACK_1 = new Icon(require("./assets/images/anup_1.png"), 166, 5);
const ICON_THUMB_1 = new Icon(require("./assets/images/anup_1.png"), 18, 19);
const ICON_THUMB_2 = new Icon(require("./assets/images/anup_1.png"), 15, 19);
    ...
    return !this.state.fontLoaded ? (
      ...
      <View style={styles.container}>
        ...
        >
         ...
         {/*playbar progress end*/ }
          {/*play back button control*/ }
        <View
          style={[
        ...
        {this.state.showVideo ? (
          <View>
            ...
            >
             ...
             {/*====fast track control end include next view=================*/ }
          </View>
